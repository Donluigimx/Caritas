...
public final class RespuestaDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + Respuesta.RespuestaEntry.TABLE_NAME + " (" +
                    ...
                    Respuesta.RespuestaEntry.COLUM_NAME_PALABRA + TEXT_TYPE + COMMA_SEP +
                    Respuesta.RespuestaEntry.COLUM_NAME_AGRADABLE + INTEGER_TYPE + COMMA_SEP +
                    Respuesta.RespuestaEntry.COLUM_NAME_REACCION + INTEGER_TYPE + COMMA_SEP +
                    Respuesta.RespuestaEntry.COLUM_NAME_DOMINIO + INTEGER_TYPE  + " )";

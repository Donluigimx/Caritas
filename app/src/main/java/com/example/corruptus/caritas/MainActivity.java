...
import com.example.corruptus.caritas.db.Respuesta;
import com.example.corruptus.caritas.db.RespuestaDbHelper;
import com.example.corruptus.caritas.utils.Resizer;
...
public class MainActivity extends AppCompatActivity {
        ...
        try {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    values.put(Respuesta.RespuestaEntry.COLUM_NAME_PALABRA, palabra);
                    values.put(Respuesta.RespuestaEntry.COLUM_NAME_AGRADABLE, agradable);
                    values.put(Respuesta.RespuestaEntry.COLUM_NAME_DOMINIO, control);
                    values.put(Respuesta.RespuestaEntry.COLUM_NAME_REACCION, reaccion);
                    db.insert(
    ...
    private void check_offline() {
        ...
        String[] projection = {
                ...
                Respuesta.RespuestaEntry.COLUM_NAME_PALABRA,
                Respuesta.RespuestaEntry.COLUM_NAME_DOMINIO,
                Respuesta.RespuestaEntry.COLUM_NAME_REACCION,
                Respuesta.RespuestaEntry.COLUM_NAME_AGRADABLE
        };
        ...
        try (Cursor c = db.query(Respuesta.RespuestaEntry.TABLE_NAME, projection, null, null, null, null, null)){
            while (c.moveToNext()) {
                ...
                int agradable = c.getInt(c.getColumnIndex(Respuesta.RespuestaEntry.COLUM_NAME_AGRADABLE));
                int dominio = c.getInt(c.getColumnIndex(Respuesta.RespuestaEntry.COLUM_NAME_DOMINIO));
                int reaccion = c.getInt(c.getColumnIndex(Respuesta.RespuestaEntry.COLUM_NAME_REACCION));
                String palabra = c.getString(c.getColumnIndex(Respuesta.RespuestaEntry.COLUM_NAME_PALABRA));
